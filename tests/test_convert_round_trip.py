...
def test_convert_absolute_then_back_relative_round_trip(project, monkeypatch):
    ...
    to_abs = _import("convert_to_absolute", repo_root / "scripts" / "convert_to_absolute.py")
    to_rel = _import("convert_to_relative", repo_root / "scripts" / "convert_to_relative.py")
    ...
    assert str(img.resolve()) in abs_text, "Absolute path should appear after conversion"
