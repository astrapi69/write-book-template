...
def _install_fake_adapter_module(module_name: str, class_name: str, raises_on_kwargs=None):
    """
...
def test_get_tts_adapter_elevenlabs_with_and_without_key(monkeypatch):
    ...
    def raises_on_kwargs(kwargs): return not kwargs.get("api_key")
    _install_fake_adapter_module("scripts.tts.elevenlabs_adapter", "ElevenLabsAdapter", raises_on_kwargs)
