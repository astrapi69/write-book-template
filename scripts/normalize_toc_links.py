...
def main():
    ap = argparse.ArgumentParser(description="Normalize TOC links for single-file export.")
    ap.add_argument("--toc", default="manuscript/front-matter/toc.md", help="Pfad zur TOC-Datei")
    ap.add_argument("--mode", choices=["strip-to-anchors", "replace-ext"], default="strip-to-anchors",
